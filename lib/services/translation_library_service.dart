...
class TranslationLibraryService {
  ...
  /// 1. Ayah translation seed (when includeAyahSeed is true).
  /// 2. Cached bundle from a previous successful API fetch.
  /// 3. Bundled assets seed (`assets/json/intl_<lang>.json`).
  ///
